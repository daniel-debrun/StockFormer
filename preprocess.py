...
if __name__ == "__main__":
    ...
    # Clear the 'training_periods' directory
    for filename in os.listdir('training_periods'):
        file_path = os.path.join('training_periods', filename)
        try:
    ...
    config['model_params']['num_stocks'] = len(tickers)
